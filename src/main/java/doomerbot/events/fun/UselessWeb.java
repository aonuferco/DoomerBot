...
public class UselessWeb {
    ...
    private static  ArrayList<String> websites = new ArrayList<>(Arrays.asList(
            "http://heeeeeeeey.com/",
    ...
    public static void execute(@Nonnull GuildMessageReceivedEvent event) {
        ...
        String rdmString = websites.get(rdm.nextInt(websites.size()));
        event.getChannel().sendMessage("Here's your useless website: " + rdmString).queue();
    }
}
